namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // vlaue변수의 값과 if ~ else문으로 짝수 홀수 구분해서 출력하기
            int value = 5;
            ...
            // 문제: 21억 이하이면 'int'타입으로 변환이 가능'이 출력이 되는 코드 작성
            if (value <= 210000000) Console.WriteLine("int타입으로 변환이 가능");
            ...
            {
                Console.WriteLine("운전 불가");
            }

            // 문제2. 아래 변수 isWeekend와 isHoliday중 하나라도 true일 경우 '쉬는 날입니다.'를 출력
            //                                                   false일 경우 '일하는 날입니다.'라고 출력
            bool isWekend = false;
            bool isHoliday = true;
            if (isWekend || isHoliday)
            {
                Console.WriteLine("쉬는 날입니다");
            }
            else
            {
                Console.WriteLine("일하는 날입니다");
            }
        }
    }
}
