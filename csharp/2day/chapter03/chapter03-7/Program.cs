...
class Program
{
    static void Main(string[] args)
    {
        ...
        // 문제2. 아래 isWeekend와 isHoliday 중 하나라도 true일 경우 true를 출력 아니면 false를 출력
        bool isweekend = false;
        bool isHoliday = true;
        Console.WriteLine(isHoliday || isweekend);

        // 문제3. 아래 변수를 이용하여 조건을 만족할 때 true 아니면 false
        // temperatuer 20 이상 30이하
        // isRainy
        int temperature = 25;
        bool isRainy = false;
